...
const ApplicationsItemBooleanToggle: React.FC<ApplicationsItemBooleanToggleProps> = ({ isPaid, id }) => {
    ...
    return (
      <div className="applications-item__block-boolean">
        <div className="applications-item__block-boolean-part">
          <input type="checkbox" checked={checked} onChange={handleCheckboxChange} className="applications-item__block-boolean-checkbox" />
          <div className="applications-item__block-boolean-text">{checked ? 'Оплачен' : 'Не оплачен'}</div>
        </div>
        <div className="applications-item__block-boolean-part">
          {
            isLoading ? <div className="applications-item__block-loader"></div> : <>
              ...
              <button className="applications-item__block-btn" onClick={updateIsPaid}>
  ...
  return (
    <div className="applications-item__block-boolean">
      <div className="applications-item__block-boolean-part">
        <h4 className="applications-item__block-value">{checked ? 'Да' : 'Нет'}</h4>
      </div>
      <div className="applications-item__block-boolean-part">
