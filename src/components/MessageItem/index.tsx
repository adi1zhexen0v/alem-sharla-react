...
const MessageItem = ({
  ...
  const [imageIsOpen, setImageIsOpen] = useState<boolean>(false);
	const className = isManager ? 'chat-typing__body-message chat-typing__body-message-self' : 'chat-typing__body-message';
		...
		<div className={className}>
      {
        type === MessageTypes.IMAGE ? (
          ...
          <div className="chat-typing__body-message-box">
            <Link to={message} className="chat-typing__body-message-box-file" target="_blank">
              <span>
